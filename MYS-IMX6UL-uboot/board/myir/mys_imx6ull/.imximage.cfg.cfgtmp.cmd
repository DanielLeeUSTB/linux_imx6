cmd_board/myir/mys_imx6ull/imximage.cfg.cfgtmp := arm-poky-linux-gnueabi-gcc -E -Wp,-MD,board/myir/mys_imx6ull/.imximage.cfg.cfgtmp.d  -nostdinc -isystem /opt/myir-imx-fb/4.1.15-2.0.1/sysroots/x86_64-pokysdk-linux/usr/lib/arm-poky-linux-gnueabi/gcc/arm-poky-linux-gnueabi/5.3.0/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__    -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations  -fno-pic  -mno-unaligned-access  -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -pipe  -march=armv7-a     -x c -o board/myir/mys_imx6ull/imximage.cfg.cfgtmp board/myir/mys_imx6ull/imximage.cfg

source_board/myir/mys_imx6ull/imximage.cfg.cfgtmp := board/myir/mys_imx6ull/imximage.cfg

deps_board/myir/mys_imx6ull/imximage.cfg.cfgtmp := \
...
board/myir/mys_imx6ull/imximage.cfg.cfgtmp: $(deps_board/myir/mys_imx6ull/imximage.cfg.cfgtmp)
